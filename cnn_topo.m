...
I_ext(1, 4000:5800) = 50;
I_ext(2, 4000:5800) = 50;
I_ext(3, 4000:5800) = 50;
%I_ext(1, 4300:4310) = 20;
...
%figure; plot(time, V(1, :), time, V(6, :), time, V(9, :));
figure; plot(time, V([1, 6, 7, 8, 9], :));
figure;
subplot(4,1,1);  plot(time, squeeze(Ca(1,6,:)));
subplot(4,1,2);  plot(time, squeeze(g_ampa(1,6,:)));
